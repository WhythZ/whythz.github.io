...
### 1.3 并查集应用
- [此课件](/resources/数据结构/DSU应用.pdf)内介绍了DSU用于图像处理、迷宫生成的示例，建议先看完后文原理再回来阅读，然后可尝试用并查集解决力扣上的[岛屿数量](https://leetcode.cn/problems/number-of-islands/description/?envType=study-plan-v2&envId=top-100-liked)问题
