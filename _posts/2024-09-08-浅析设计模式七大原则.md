...
#### 8.3 案例
- 考虑以下三个对象：游戏、角色扮演游戏、开放世界游戏，这三个对象间就不应当使用继承关系，因为如果使角色扮演游戏、开放世界游戏二者继承于游戏的话，意味着角色扮演游戏就不能是开放世界游戏了
- 正确的设计是设计一个抽象类“游戏类型”，使角色扮演游戏、开放世界游戏二者继承于“游戏类型”下，一个游戏实例可以包含多个“游戏类型”的标签